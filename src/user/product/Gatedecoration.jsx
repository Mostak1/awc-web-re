...
// import imgurl from '../../assets/picture/all/'
export const Gatedecoration = () => {
    ...
    // data get from api
    // const dataApi =
    // "http://localhost/WDPF/react/wedding-solutions/public/index.php/api";
    const imgurl = 'https://mostaksarker.com/picture/gate/';
    const dataApi = 'https://mostaksarker.com/API/alltableapi.php';
    useEffect(() => {
