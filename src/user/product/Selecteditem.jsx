...
export const Selecteditem = () => {
  ...
  //image url
  const gimgUrl =
    "https://mostaksarker.com/picture/gate/";
  const simgUrl =
    "https://mostaksarker.com/picture/stage/";
  const phimgUrl =
    "https://mostaksarker.com/picture/photoshoot/";
  const himgUrl =
    "https://mostaksarker.com/picture/hall/";
  ...
  const sendCartItemsToDatabase = () => {
    ...
    axios
      .post(
        "https://mostaksarker.com/API/ordersubmit.php",
        payload
      )
      .then((response) => {
        console.log("Selected items sent to database:", response.data);
        alert("Selected items save", response.data);
        setIsSending(false);
      })
      .catch((error) => {
